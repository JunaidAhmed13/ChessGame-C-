...
sf::Texture Bishop::whiteTexture;
sf::Texture Bishop::blackTexture;
bool Bishop::texturesLoaded = false;

void Bishop::loadTextures() {
    if (!texturesLoaded) {
        if (!whiteTexture.loadFromFile("images/white/bishop.png"))
            std::cerr << "Failed to load images/white/bishop.png\n";
        if (!blackTexture.loadFromFile("images/black/bishop.png"))
            std::cerr << "Failed to load images/black/bishop.png\n";
        texturesLoaded = true;
    }
}
...
bool Bishop::isValidMove(int sx, int sy, int dx, int dy, const Board& board) {
